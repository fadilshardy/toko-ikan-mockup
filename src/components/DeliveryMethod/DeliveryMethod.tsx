        ...
        <div className="flex lg:justify-between lg:pt-32 lg:flex-row flex-col pb-64">
            ...
            <div className="relative h-full w-full">
                ...
                <div className="absolute left-5 lg:-left-28 top-0 h-96 w-44 lg:w-[372px]">
                    <Image src="/images/floating-fish-2.png" alt="background pattern" fill={true} quality="100" className="object-contain" />
                </div>
                <div className="absolute -top-40 lg:left-28 -right-16 h-[727px] w-full">
                    <Image src="/images/mobile-2.png" alt="Mobile showcase" fill={true} quality="100" className="object-contain" />
                </div>
            </div>
        </div>
    </section>
